let choice = prompt("0.Дополнительное задание\nPractic1.Задание Practic1\nPractic2.Задание Practic2\nPractic3.Задание Practic3\nPractic4.Задание Practic4\nPractic5.Задание Practic5\n6.Задание 6\n" + "Введите номер задания");
console.log(choice)
if (choice != null) {
...
function Ex5(){
    ...
    while(true){
        var num = Number(prompt("Вгадай число від Practic1 до Practic5:"));
        if (0<num||num>5)
        if (num === number){
